cp tool/idalic.hexlic "/Applications/IDA Professional 9.0.app/Contents/MacOS/ida.hexlic"
...
if [ -f "/Applications/IDA Professional 9.0.app/Contents/MacOS/plugins/arm_mac_user64.dylib" ]; then
    # 还没处理好 先删除吧
