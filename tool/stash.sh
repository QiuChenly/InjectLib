...
/usr/bin/codesign -f -s - --all-architectures --deep /Applications/Stash.app/Contents/Library/LaunchServices/ws.stash.app.mac.daemon.helper
/usr/bin/codesign -f -s - --all-architectures --deep /Applications/Stash.app
